...
class PokemonData(JsonFile):
    ...
    def _initMoveData(self):
        ...
        self.tmhm_learnset = self._file["tmhm_learnset"]
        self.tutor_learnset = self._file["tutor_learnset"]
    ...
    def _formatLearnsets(self):
        ...
        self.formated_tmhm_learnset = formatTMHMLearnset(self.species, self.tmhm_learnset)
        self.formated_tutor_learnset = formatTutorLearnset(self.species, self.tutor_learnset)
...
class SpeciesNamesH(HeaderFile):
    ...
    def appendData(self, species, prevMon):
        ...
        self.insertBlankLine(idx)
        self.set_line(idx, f'    [SPECIES_{species.upper()}] = _(\"{species.upper()}\"),\n')
